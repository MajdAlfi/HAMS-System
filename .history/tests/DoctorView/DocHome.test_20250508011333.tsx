...
jest.mock("../../src/Components/DoctorView/Home/AptDoctorHome", () => ({
  AptDoctorHome: () => <div>🏠 Apt Home</div>,
}));

jest.mock(
  "../../src/Components/DoctorView/ManageAvailability/DocManageAvailability",
  () => ({
    DocManageAvailability: () => <div>📅 Availability Manager</div>,
  })
);

jest.mock("../../../src/Components/DoctorView/Profile/DocProfile", () => ({
