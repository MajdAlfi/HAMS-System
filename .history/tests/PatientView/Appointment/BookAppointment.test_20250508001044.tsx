...
jest.mock("../../../Services/API/fetchDocList", () => ({
...
jest.mock("../../../Services/API/FetchDocAvailability", () => ({
...
jest.mock("../../../Services/Appointments/bookApt", () => ({
  bookApt: jest.fn(() => Promise.resolve(200)),
}));

jest.mock("../../../Services/Others/useQuery", () => ({
