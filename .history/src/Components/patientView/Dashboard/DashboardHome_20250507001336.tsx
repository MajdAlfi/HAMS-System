...
import { fetchUserAppointmentsToEvents } from "../../../Services/Appointments/getUserApt";
...
export const DashboardHome = () => {
  ...
  useEffect(() => {
    ...
    // suggestions.map((e) => alert(e.doctorName));

    fetchSuggestions();
  }, []);
  const [events, setEvents] = useState<{ allDay: boolean; start: Date }[]>([]);
