...
export const DashboardHome = () => {
  ...
  const events = [
    { allDay: true, start: new Date(2025, 3, 20) },
    { allDay: true, start: new Date(2025, 3, 22, 10, 0) },
  ];
  ...
  const suggestionItems = suggestions.map((s, index) => () => (
    <SuggestionBox key={index} suggestion={s} doctorName="Doctor" />
  ));
