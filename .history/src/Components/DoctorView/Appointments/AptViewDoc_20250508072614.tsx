...
export const AptViewDoc = () => {
  ...
  return (
    ...
    >
      ...
      <button
        disabled={apt.State === "Cancelled"}
        style={{
          color: "white",
          backgroundColor: apt.State === "Cancelled" ? "grey" : "red",
          display: isView ? "inline-block" : "none",
          width: "30vw",
          height: "8vh",
          fontWeight: "bold",
          ...
          marginTop: "5vh",
          borderRadius: "30px",
          cursor: apt.State === "Cancelled" ? "not-allowed" : "pointer",
        }}
        onClick={async () => {
      ...
      <button
        ...
        style={{
          color: "white",
          backgroundColor:
            apt.State === "Cancelled" ? "grey" : "rgba(4, 230, 0, 0.77)",
          display: isView ? "inline-block" : "none",
          width: "30vw",
          height: "8vh",
          fontWeight: "bold",
        ...
        onClick={() => navigate(`/diagnosis/${apt._id}`)}
      >
        Next
      </button>
    </div>
